...
namespace AdoNetTest.DataBinding
{
	/// <summary>
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private AdoNetTest.DataBinding.AuthorsDataSet authorsDataSet1;
		...
		{
			if (myCM.Position == 0)
				MessageBox.Show("Estas en el principio, jeton!!!");
			else
				myCM.Position -= 1;
		}
		...
		private void btnNext_Click(object sender, System.EventArgs e)
		{
			if (myCM.Position == (myCM.Count - 1))
				MessageBox.Show("LLegaste al final, jeton!!!");
			else
				myCM.Position += 1;
		}
	}
