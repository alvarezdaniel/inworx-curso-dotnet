...
public abstract class DCE3Sc : System.Web.Services.WebService {
    ...
    public abstract bool EsUsuarioValido(string Usuario, string Clave);
    ...
    public abstract int GetCantidadEstrellas(string Usuario);
    ...
    public abstract BolsaSC_Info GetPerfilUsuario(string Usuario);
}
